...
class EmailPengadaan extends Component {
    state = {
        message: '',
        subject: '',
    }
                    ...
                    {detailIo.length > 0 && detailIo.map((item, index) => (
                        <View key={index} style={styles.assetCardModal}>
                            ...
                            <View style={styles.assetRowModal}>
                                ...
                                <Text style={styles.assetValueModal}>{item.price}</Text>
                            </View>
                            <View style={styles.assetRowModal}>
                                <Text style={styles.assetLabelModal}>Jenis:</Text>
                                <Text style={styles.assetValueModal}>{item.jenis}</Text>
                            </View>
                            <View style={styles.assetRowModal}>
...
export default connect(mapStateToProps)(EmailPengadaan);
