...
export default {
    ...
    addDisposal: (token, data) => ({
        type: 'ADD_DISPOSAL',
        payload: http(token).post('/disposal/add', qs.stringify(data)),
    }),
    addSell: (token, data) => ({
        type: 'ADD_DISPOSAL',
    ...
    addDokumenUser: (token, data) => ({
        type: 'ADD_DOKUMEN_USER_DISPOSAL',
        payload: http(token).post('/disposal/add-dokumen', data),
    }),
    deleteDokumenUser: (token, id) => ({
        type: 'DELETE_DOKUMEN_USER_DISPOSAL',
        payload: http(token).delete(`/disposal/delete-dokumen/${id}`),
    }),
    reset: () => ({
        type: 'RESET_DISPOSAL',
    }),
