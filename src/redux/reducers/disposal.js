const disposalState = {
    ...
    deleteDocUser: null,
    statusDisposal: [
        { status: 'sell', name: 'Penjualan' },
        { status: 'auction', name: 'Lelang' },
        { status: 'dispose', name: 'Pemusnahan' },
        { status: 'incident', name: 'Hilang (Ganti Rugi)' },
        { status: 'special', name: 'Special Case' },
    ],
    flowDisposal: [
        { status: 'sell', name: 'Penjualan' },
        { status: 'dispose', name: 'Pemusnahan' },
    ...
    listSpecialCase: [
        { type_special: 'compensation', name: 'Compensation' },
        { type_special: 'intercompany_sale', name: 'Intercompany Sale'  },
    ],
    listMenuRev: [
        { val: 'Revisi Area', menu: 'disposal-req' },
        { val: 'Revisi Purchasing', menu: 'disposal-req' },
    ],
};
...
export default (state = disposalState, action) => {
        switch (action.type){
            ...
            case 'ADD_DOKUMEN_USER_DISPOSAL_PENDING': {
                return {
                    ...state,
                    isLoading: true,
                    alertMsg: 'Waiting ...',
            ...
            case 'ADD_DOKUMEN_USER_DISPOSAL_FULFILLED': {
                return {
                    ...state,
                    isLoading: false,
                    addDocUser: true,
            ...
            case 'ADD_DOKUMEN_USER_DISPOSAL_REJECTED': {
                return {
                    ...state,
                    isLoading: false,
                    addDocUser: false,
            ...
            case 'DELETE_DOKUMEN_USER_DISPOSAL_PENDING': {
                return {
                    ...state,
                    isLoading: true,
                    alertMsg: 'Waiting ...',
            ...
            case 'DELETE_DOKUMEN_USER_DISPOSAL_FULFILLED': {
                return {
                    ...state,
                    isLoading: false,
                    deleteDocUser: true,
            ...
            case 'DELETE_DOKUMEN_USER_DISPOSAL_REJECTED': {
                return {
                    ...state,
                    isLoading: false,
                    deleteDocUser: false,
