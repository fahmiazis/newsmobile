...
import IconAweOld from 'react-native-vector-icons/FontAwesome';
...
class TaxFinDisposal extends Component {
  ...
  setEditDate = (event, selectedDate, type) => {
    ...
    if (selectedDate) {
      this.setState({date_faktur: selectedDate});
    }
  };

  handlePrice = (val) => {
    const oriPrice = val.replace(/\D/g, '');
    this.setState({
      nominal: oriPrice,
      displayNominal: oriPrice ? `Rp ${this.formatCurrency(oriPrice)}` : '',
    });
  };
  ...
  updateDataDis = async () => {
    ...
    const {
      ...
      doc_clearing,
      no_fp,
      date_faktur } = this.state;

    const data = {
      nominal: nominal,
      no_sap: no_sap,
      doc_sap: doc_sap,
      doc_clearing: doc_clearing,
      no_fp: no_fp,
      date_faktur: date_faktur,
    };
    const statusDoc = level === '3' ? 'taxDis' : level === '4' ? 'financeDis' : undefined;
    await this.props.updateDisposal(token, detailData.id, data, statusDoc);
  ...
  prosesOpenRinci = (val) => {
    this.setState({
      detailData: val,
      nominal: val.nominal,
      displayNominal: val.nominal === null || val.nominal === '' ? 0 : this.formatCurrency(val.nominal),
      doc_sap: val.doc_sap,
      no_sap: val.no_sap,
      doc_clearing: val.doc_clearing,
      no_fp: val.no_fp,
    });
    this.openRinci();
  }
  ...
  openProsesDocTax = async (val) => {
    const {dataUser, token} = this.props.auth;
    this.setState({tipeDoc: 'tax disposal'});
    const data = {
      noId: val.id,
      noAsset: val.no_asset,
    };
  ...
  openProsesDocFinance = async (val) => {
    const {dataUser, token} = this.props.auth;
    this.setState({tipeDoc: 'finance disposal'});
    const data = {
      noId: val.id,
      noAsset: val.no_asset,
    };
  ...
  prosesTypeDokumen = async (val, type, typeDoc) => {
    const {dataUser, token} = this.props.auth;
    this.setState({tipeDoc: typeDoc});
    const data = {
      noId: val.id,
      noAsset: val.no_asset,
    };
    if (type === 'eksekusi') {
      ...
      await this.props.getDocumentDis(token, data, 'disposal', type);
      this.openDokumen();
    }
  }
  ...
  render() {
    ...
    return (
            ...
            <ScrollView style={styles.scrollContentModal}>
              ...
              {level === 2 && (
                <>
                  <View style={styles.sectionModal}>
                    <Text style={styles.sectionTitleModal}>Gl Debit</Text>
                      <TextInput 
                      style={styles.assetCardModal} 
                      onChangeText={(val) => this.setState({ gl_debit: val })} 
                      value={this.state.gl_debit} />
                  </View>

                  <View style={styles.sectionModal}>
                    <Text style={styles.sectionTitleModal}>Gl Credit</Text>
                      <TextInput 
                      style={styles.assetCardModal} 
                      onChangeText={(val) => this.setState({ gl_credit: val })} 
              ...
              {detailDis.length > 0 && detailDis.map((item, index) => (
                <View key={index} style={[styles.assetCardModal, item.status_app === 0 ? styles.note : listMut.find(element => element === item.id) !== undefined ? styles.note : styles.backgroundWhite]}>
                  ...
                  <TouchableOpacity
                    style={[styles.buttonDoc, styles.btnColorProses, { marginBottom: 10 }]}
            ...
            <ScrollView style={styles.scrollContentModal}>
              ...
              {this.state.confirm === 'approve' ? (
                  ...
                  <View style={styles.sectionInfo}>
                    ...
                    <Text style={[styles.sectioSubtitleInfo]}>Mohon approve dokumen tax dan finance terlebih dahulu</Text>
                    <TouchableOpacity style={styles.btnInfo} onPress={this.openConfirm}>
                      <Text style={styles.textBtnInfo}>OK</Text>
                    </TouchableOpacity>
                  </View>
                  ...
                  <View style={styles.sectionInfo}>
                    <IconMateri name="close" color={'red'} size={50}/>
                    <Text style={styles.sectionTitleInfo}>Gagal Submit</Text>
                    <Text style={[styles.sectioSubtitleInfo]}>Pastikan nomor document SAP dan no document clearing telah diinput</Text>
                    <TouchableOpacity style={styles.btnInfo} onPress={this.openConfirm}>
                      <Text style={styles.textBtnInfo}>OK</Text>
                    </TouchableOpacity>
                  </View>
                  ...
                  <View style={styles.sectionInfo}>
                    <IconMateri name="close" color={'red'} size={50}/>
                    <Text style={styles.sectionTitleInfo}>Gagal Submit</Text>
                    <Text style={[styles.sectioSubtitleInfo]}>Pastikan faktur pajak telah diinput</Text>
                    <TouchableOpacity style={styles.btnInfo} onPress={this.openConfirm}>
                      <Text style={styles.textBtnInfo}>OK</Text>
                    </TouchableOpacity>
                  </View>
                  ...
                  <View style={styles.sectionInfo}>
                    <IconMateri name="close" color={'red'} size={50}/>
                    <Text style={styles.sectionTitleInfo}>Gagal Submit</Text>
                    <Text style={[styles.sectioSubtitleInfo]}>Pastikan nomor dokumen finance dan nominal telah diinput</Text>
                    <TouchableOpacity style={styles.btnInfo} onPress={this.openConfirm}>
                      <Text style={styles.textBtnInfo}>OK</Text>
                    </TouchableOpacity>
                  </View>
        ...
        <View style={styles.overlayModal}>
          <View style={styles.popupContainerInfo}>
            <ScrollView style={styles.scrollContentModal}>
              ...
              parDoc={{
                arrDoc: dataDoc,
                proses: filter === 'available' ? (level === 3 || level === 4 ? 'upload' : 'approval') : 'show',
      ...
      >
        ...
        <ScrollView>
          ...
          <View style={styles.formGroupDetail}>
            ...
            <TextInput style={styles.inputDetail} editable={false} value={detailData.nilai_buku === null || detailData.nilai_buku === '' ? 0 : this.formatCurrency(detailData.nilai_buku)} />
          </View>
          ...
          {(level === 2) && (
            <>
              <View style={styles.formGroupDetail}>
                <Text style={styles.labelDetail}>Faktur Pajak :</Text>
                <TextInput style={styles.inputDetail} value={detailData.no_fp} editable={false} />
              </View>
              <View style={styles.formGroupDetail}>
                <Text style={styles.labelDetail}>No Doc Finance :</Text>
                <TextInput style={styles.inputDetail} value={detailData.no_sap} editable={false} />
              </View>
              <View style={styles.formGroupDetail}>
                <Text style={styles.labelDetail}>Nominal uang masuk : {detailData.nominal === null || detailData.nominal === '' ? 0 : this.formatCurrency(detailData.nominal)}</Text>
                <TextInput style={styles.inputDetail} value={detailData.no_sap} editable={false} />
              </View>
          ...
          {(level === 3) && (
            <>
              <View style={styles.formGroupDetail}>
                <Text style={styles.labelDetail}>Faktur Pajak :</Text>
                <TextInput style={styles.inputDetail} value={this.state.no_fp} onChangeText={val => this.setState({no_fp: val})} />
                {(this.state.no_fp === '' || !this.state.no_fp) && (
                  <Text style={styles.errorTextDetail}>Must be filled</Text>
                )}
              </View>
              <View style={styles.formGroupDetail}>
                <Text style={styles.labelDetail}>Tgl Faktur :</Text>
                <TouchableOpacity style={styles.inputDetail} onPress={() => this.setState({openEditDate: true})}>
                  <Text style={styles.textColor}>{moment(this.state.date_faktur).format('DD MMMM YYYY')}</Text>
                </TouchableOpacity>
                {(this.state.date_faktur === '' || !this.state.date_faktur) && (
                  <Text style={styles.errorTextDetail}>Must be filled</Text>
                )}
              </View>
          ...
          {(level === 4) && (
            <>
              <View style={styles.formGroupDetail}>
                <Text style={styles.labelDetail}>No Doc Finance :</Text>
                <TextInput style={styles.inputDetail} value={this.state.no_sap} onChangeText={val => this.setState({no_sap: val})} />
                {(this.state.no_sap === '' || !this.state.no_sap) && (
                  <Text style={styles.errorTextDetail}>Must be filled</Text>
                )}
              </View>
              <View style={styles.formGroupDetail}>
                <Text style={styles.labelDetail}>Nominal uang masuk :</Text>
                <TextInput
                  ...
                  value={this.state.displayNominal}
                  onChangeText={this.handlePrice}
                />
                {isNaN(parseInt(this.state.nominal)) && (
                  <Text style={styles.errorTextDetail}>Must be filled</Text>
                )}
              </View>
            </>
          ...
          <View style={styles.footerModal}>
            <TouchableOpacity
              style={[styles.buttonModal, styles.btnColorApprove]}
              onPress={
                level === 3 ? () => this.openProsesDocTax(detailData)
                : level === 4 ? () => this.openProsesDocFinance(detailData)
                : () => this.openTypeDoc()
              }
            >
              <Text style={styles.buttonTextModal}>
                {level === 3 || level === 4 ? 'Upload ' : ''}Dokumen
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[styles.buttonModal, styles.btnColorProses]}
          ...
          <View style={styles.footerModal}>
            <TouchableOpacity style={[styles.buttonModal, styles.btnColorSec]} onPress={this.openRinci}>
              <Text style={styles.buttonTextModal}>Close</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      ...
      <Modal
        ...
        animationIn="slideInUp"
        animationOut="slideOutDown"
        onBackdropPress={this.openTypeDoc}
        useNativeDriver={true}
      >
        <View style={styles.overlayModal}>
          <View style={styles.popupContainerModal}>
            ...
            {/* Header */}
            <View style={styles.headerContainerModal}>
              <Text style={styles.headerTitleModal}>Pilih Dokumen Lampiran</Text>
            </View>
            ...
            <View style={styles.rowCard}>
              <>
                <TouchableOpacity
                  ...
                  onPress={() => this.prosesTypeDokumen(detailData, 'pengajuan', 'disposal')}
                >
                  <IconAweOld name="send" size={100}  />
                  <View style={styles.nameContainerCard}>
                    <Text style={styles.nameTextCard} numberOfLines={2}>Dokumen Ajuan</Text>
                  </View>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.assetCard, { width: cardWidthList }]}
                  onPress={() => this.prosesTypeDokumen(detailData, 'eksekusi', 'eksekusi disposal')}
                >
                  <IconAweOld name="truck" size={100}  />
                  <View style={styles.nameContainerCard}>
                    <Text style={styles.nameTextCard} numberOfLines={2}>Dokumen Eksekusi</Text>
                  </View>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.assetCard, { width: cardWidthList }]}
                  onPress={() => this.prosesTypeDokumen(detailData, 'tax', 'tax disposal')}
                >
                  <IconAweOld name="gear" size={100}  />
                  <View style={styles.nameContainerCard}>
                    <Text style={styles.nameTextCard} numberOfLines={2}>Dokumen Tax</Text>
                  </View>
                </TouchableOpacity>
                <TouchableOpacity
                  style={[styles.assetCard, { width: cardWidthList }]}
                  onPress={() => this.prosesTypeDokumen(detailData, 'finance', 'finance disposal')}
                >
                  <IconAweOld name="gear" size={100}  />
                  <View style={styles.nameContainerCard}>
                    <Text style={styles.nameTextCard} numberOfLines={2}>Dokumen Finance</Text>
                  </View>
                </TouchableOpacity>
              </>
            </View>
