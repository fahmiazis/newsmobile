...
class BudgetMutasi extends Component {
  ...
  updateEksekusi = async (val) => {
    ...
    const data = {
      cost_centerawal: detailData.cost_centerawal
    }
    ...
    return (
      ...
      <View style={{flex: 1}}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.bodyTitle}>
            <Text style={styles.title}>Verifikasi Budget Mutasi Asset</Text>
          </View>
              ...
              {detailMut.length > 0 && detailMut.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <View style={styles.assetRowModal}>
                      <Text style={styles.assetLabelModal}>Cost Center Awal:</Text>
                      <Text style={styles.assetValueModal}>{item.cost_centerawal}</Text>
                    </View>
                  </TouchableOpacity>
                  <TouchableOpacity
      ...
      >
        <EmailModal
          ...
          handleSubmit={tipeEmail === 'reject' ? () => this.rejectMutasi(dataRej) : this.submitMutasi}
      ...
      <Modal
              ...
              <ScrollView style={styles.scrollContentModal}>
                ...
                {this.state.confirm === 'approve' ? (
                    ...
                    <View style={styles.sectionInfo}>
                      ...
                      <Text style={[styles.sectioSubtitleInfo]}>Mohon untuk isi cost center awal terlebih dahulu</Text>
                      <TouchableOpacity style={styles.btnInfo} onPress={this.openConfirm}>
                        <Text style={styles.textBtnInfo}>OK</Text>
                      </TouchableOpacity>
                    </View>
        ...
        >
          <View style={styles.overlayModal}>
            <View style={styles.popupContainerInfo}>
              <ScrollView style={styles.scrollContentModal}>
                <ModalDokumen handleClose={this.openDokumen} />
              </ScrollView>
            </View>
          </View>
        </Modal>
        ...
        >
          <View style={styles.modalContainerDetail}>
            <ScrollView>
              ...
              <View style={styles.formGroupDetail}>
                <Text style={styles.labelDetail}>Cost Center Awal :</Text>
                <TextInput style={[styles.inputDetail, styles.backgroundWhite]} value={detailData.cost_centerawal} onChangeText={(val) => this.setState({detailData: { ...detailData, cost_centerawal: val }})}/>
                {(detailData.isbudget === 'ya' && (detailData.cost_centerawal === null || detailData.cost_centerawal === '')) && (
                  <Text style={styles.errorTextDetail}>Must be filled</Text>
                )}
              </View>
              ...
              <View style={styles.buttonWrapperDetail}>
                <TouchableOpacity
                  disabled={detailData.isbudget === 'ya' && (detailData.cost_centerawal === null || detailData.cost_centerawal === '')}
