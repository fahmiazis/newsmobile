...
class EksekusiMutasi extends Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
  ...
  updateEksekusi = async (val) => {
    ...
    await this.props.updateStatus(token, detailData.id, data);
    ...
    return (
      ...
      <View style={{flex: 1}}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.bodyTitle}>
            <Text style={styles.title}>Eksekusi Mutasi Asset</Text>
          </View>
              ...
              {detailMut.length > 0 && detailMut.map((item, index) => (
                ...
                >
                  ...
                  >
                    ...
                    <View style={styles.assetRowModal}>
                      <Text style={styles.assetLabelModal}>No Doc SAP:</Text>
                      <Text style={styles.assetValueModal}>{item.doc_sap}</Text>
                    </View>
                    <View style={styles.assetRowModal}>
                      <Text style={styles.assetLabelModal}>Konfirmasi Budget:</Text>
                    </View>
                    <View style={styles.rowCheck}>
                      <CheckBox
                        style={{ margin: 0 }}
                        value={item.isbudget === 'ya' ? true : false}
                      />
                      <Text style={styles.docName}>Ya</Text>
                      <CheckBox
                        style={{ margin: 0 }}
                        value={item.isbudget === 'ya' ? false : true}
                      />
                      <Text style={styles.docName}>Tidak</Text>
                    </View>
                  </TouchableOpacity>
                  <TouchableOpacity
      ...
      >
        <EmailModal
          ...
          handleSubmit={tipeEmail === 'reject' ? () => this.rejectMutasi(dataRej) : this.prosesSubmit}
              ...
              <ScrollView style={styles.scrollContentModal}>
                ...
                {this.state.confirm === 'approve' ? (
                    ...
                    <View style={styles.sectionInfo}>
                      <IconMateri name="close" color={'red'} size={50}/>
                      <Text style={styles.sectionTitleInfo}>Gagal Submit</Text>
                      <Text style={[styles.sectioSubtitleInfo]}>Mohon untuk isi no doc sap terlebih dahulu</Text>
                      <TouchableOpacity style={styles.btnInfo} onPress={this.openConfirm}>
                        <Text style={styles.textBtnInfo}>OK</Text>
                      </TouchableOpacity>
                    </View>
                    ...
                    <View style={styles.sectionInfo}>
                      <IconMateri name="close" color={'red'} size={50}/>
                      <Text style={styles.sectionTitleInfo}>Gagal Submit</Text>
                      <Text style={[styles.sectioSubtitleInfo]}>Mohon untuk approve dokumen terlebih dahulu</Text>
                      <TouchableOpacity style={styles.btnInfo} onPress={this.openConfirm}>
                        <Text style={styles.textBtnInfo}>OK</Text>
                      </TouchableOpacity>
                    </View>
            ...
            <View style={styles.popupContainerInfo}>
              <ScrollView style={styles.scrollContentModal}>
                <ModalDokumen 
                  parDoc={{
                    arrDoc: dataDoc,
                    proses: filter === 'available' ? 'approval' : 'show',
                    tipe: 'mutasi',
          ...
          <View style={styles.modalContainerDetail}>
            <ScrollView>
              ...
              <View style={styles.buttonWrapperDetail}>
                <TouchableOpacity
                  disabled={(detailData.doc_sap === null || detailData.doc_sap === '')}
                  style={styles.addButtonDetail}
                  onPress={() => this.updateEksekusi()}
                >
                  <Text style={styles.closeButtonTextDetail}>Save</Text>
                </TouchableOpacity>
...
export default connect(mapStateToProps, mapDispatchToProps)(EksekusiMutasi);
