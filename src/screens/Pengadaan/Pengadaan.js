      ...
      <View style={{flex: 1}}>
        ...
        <View style={styles.headerContainer}>
          <View style={styles.bodyTitle}>
            <Text style={styles.title}>{level === 2 ? 'Verifikasi Asset' : level === 8 ? 'Verifikasi Budget' : 'Pengadaan Asset'}</Text>
            {(level === 5 || level === 9) && (
              <TouchableOpacity
                // onPress={() => this.props.navigation.navigate('PengadaanTab', {screen: 'CartPengadaan'})}
                onPress={() => this.props.navigation.navigate('CartPengadaan')}
              >
                ...
                {filter === 'available' && (
                  <>
                    <TouchableOpacity
                      ...
                      onPress={() => this.cekApprove((level === 2 || level === 8) ? 'submit' : 'approve')}
                    >
                      <Text style={styles.buttonTextModal}>
