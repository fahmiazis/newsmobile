...
const profileSchema = Yup.object().shape({
  ...
  kode: Yup.number().required('must be filled'),
});
          ...
          {({
            ...
            <View style={style.parent}>
                ...
                <Image
                  ...
                  source={
                    data.picture === null || data.picture === undefined
                      ? akun
                      : {uri: `http://54.147.40.208:6060${data.picture}`}
                  }
                />
              ...
              <Form>
                ...
                {(dataUser.user_level === 5 || dataUser.user_level === 9) && (
                  <>
                    <Item style={style.input}>
                      <Input
                    ...
                    {errors.kode ? (
                      <Text style={style.txtError}>{errors.kode}</Text>
                    ) : null}
                  </>
                )}
                <Item style={style.input}>
                ...
                {errors.role ? (
                  <Text style={style.txtError}>{errors.role}</Text>
                ) : null}
                ...
                <TouchableOpacity onPress={this.logout} style={style.btnLogout}>
